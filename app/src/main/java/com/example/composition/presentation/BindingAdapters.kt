...
fun bindingOnOptionClickListener(textView: TextView, chooseAnswer: OnOptionClickListener) {
    textView.setOnClickListener {
        chooseAnswer.onOptionClick(textView.text.toString().toInt())
    }
}
...
fun bindingAnswersProgress(textView: TextView, line: String) {
    textView.text = String.format(
